    ...
    <div className="min-h-screen bg-background text-foreground relative overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full bg-background/20 backdrop-blur-sm border-b border-border z-50">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <h1 className="text-xl font-bold text-primary font-mono">Mitakashime</h1>
      ...
      >
        ...
        <div className="relative z-40 max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-balance animate-pulse font-sans">
              Hi there, I'm Mitakashime!
            </h1>
            <p className="text-xl md:text-2xl mb-8 text-pretty backdrop-blur-sm bg-background/20 rounded-lg p-4 font-mono">
              Clark Jim Gabiota - Web Developer & AI Enthusiast
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button
                size="lg"
                onClick={() => scrollToSection("projects")}
                className="bg-primary hover:bg-primary/90 text-white hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-primary/25 font-mono"
              >
                View My Work
              </Button>
              <Button
                ...
                size="lg"
                onClick={() => scrollToSection("contact")}
                className="hover:bg-primary/10 hover:border-primary hover:scale-105 transition-all duration-300 font-mono text-white border-primary/50"
              >
                Get In Touch
              </Button>
            </div>
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <AnimatedText className="text-lg leading-relaxed font-mono mb-4">
              ...
              <AnimatedText className="text-lg leading-relaxed font-mono">
            ...
            {[
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <AnimatedText className="mb-4 leading-relaxed font-mono text-sm">
                    {project.description}
                  </AnimatedText>
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full group-hover:bg-primary/20 group-hover:text-white group-hover:border-primary transition-all duration-300 bg-transparent hover:scale-105 font-mono"
                  >
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          >
            <Card className="p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-border/50 hover:border-primary/30 bg-background/40 backdrop-blur-md">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <AnimatedText className="font-mono text-white">2021 - Present</AnimatedText>
              </div>
              <AnimatedText className="leading-relaxed font-mono text-white">
            ...
            <Card className="p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-border/50 hover:border-primary/30 bg-card/80 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <AnimatedText className="font-mono text-white">Summer 2023</AnimatedText>
              </div>
              <AnimatedText className="leading-relaxed font-mono text-white">
            ...
            <Card className="p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border-border/50 hover:border-primary/30 bg-card/80 backdrop-blur-sm">
              <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
                ...
                <AnimatedText className="font-mono text-white">2022 - Present</AnimatedText>
              </div>
              <AnimatedText className="leading-relaxed font-mono text-white">
